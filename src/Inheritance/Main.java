...
public class Main {
    public static void main(String[] args) {
        ...
        Waterfowl waterfowl = new Waterfowl("Chas the Swan", 3, true, true, true);
        ...
        Duck duck1 = new Duck("Alice", 4, true, true, "Crested");
        Duck duck2 = new Duck("Bob", "Crested"); // uses basic constructor
        ...
        duck1.enterWater();
        System.out.println(" > " + duck1.getName() + " is in water: " + duck1.isInWater());
        duck1.exitWater();
        System.out.println(" > " + duck2.getName() + " is in water: " + duck1.isInWater());
        duck1.quack();
        duck2.layEgg();
